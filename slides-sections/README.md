...
| 04 | `04-requirement-vs-specification.md` | Confusion #2: Requirement ≠ Specification | #2 | 3 |
...
| 08 | `08-bdd-atdd-tdd-confusion.md` *(not imported — content merged into 07)* | BDD / ATDD / TDD Confusion | #8, #9 | — |
| 09 | `09-making-agents-fail.md` | How to Make Agents Fail | #10 | 3 |
| 10 | `10-conclusion.md` | Our Role Tomorrow + Thank You | — | 3 |

**Total: ~39 slides** (+ 1 French cover in root = 40)
